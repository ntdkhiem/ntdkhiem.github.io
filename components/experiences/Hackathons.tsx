    ...
    <div className="relative text-white">
      ...
      <div className="px-20">
        ...
        <div className="relative pl-8 sm:pl-32 pb-52 group">
          ...
          >
            ...
            <li>
              ...
              &quot;Introduction to ReactJS&quot; for more than 800 participants
        ...
        <div className="relative pl-8 sm:pl-32 pb-52 group">
          ...
          >
            <li>
              I am looking forward to participating in more hackathons even
              after my graduation and possibly even start one of my own for
